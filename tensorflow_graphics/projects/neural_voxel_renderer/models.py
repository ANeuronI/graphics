...
def neural_voxel_renderer_plus(voxels,
    ...
    with tf.name_scope('Network/'):
        ...
        # Process light inputs
        fc_light = layers.Dense(64, kernel_initializer=initializer)(light_pos_input)
        light_code = layers.Dense(64, kernel_initializer=initializer)(fc_light)
        light_code = layers.Lambda(lambda v: tf.tile(v[0], [1, 32*32]))([light_code])
        light_code = layers.Reshape((32, 32, 64))(light_code)  # 32x32x64

        # Merge projections and light codes
        ...
        # Decode final latent codes to images
